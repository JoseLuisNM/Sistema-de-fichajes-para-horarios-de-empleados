...
} elseif (isset($_POST['modif_reg'])) {
    header('Location:modif_reg.php');
} elseif (isset($_POST['modif_users'])) {
    header('Location:modif_users.php');
} elseif (isset($_POST['adminHoras'])) {
    header('Location:adminHoras.php');
...
<div class="container">
    <div class="row mt-5">
        ...
        <div class="col-8 m-auto bg-white rounded shadow p-0">
            <h4 class="text-center mb-4 text-secondary mt-5">Administracion para sistema de empleados</h4><br>
            ...
            <div class="px-5 pb-5 text-center">
                ...
                <form action="admin.php" method="POST" class="m-5">
                    ...
                    <div class="col-12 py-3 mb-5 text-center">
                        ...
                        <button name="adminHoras" type="submit" class="btn btn-success m-auto">Ver registros</button>
                        <div><br>
                            <button name="modif_reg" type="submit" class="btn btn-primary m-auto">Modificar registros</button>
                            <button name="modif_users" type="submit" class="btn btn-primary m-auto">Modificar usuarios</button>
                        </div>
                    </div>
                </form>
            ...
            <form method="POST">
                <div class="col-5 m-8">
                    <button name="cerrarSesion" class="btn btn-danger form-control">Cerrar sesión Admin</button></a>
                    <p class="text-secondary text-center">¿Cerrar sesión de administrador?</p>
                </div>
            </form>
        </div>
    </div>
